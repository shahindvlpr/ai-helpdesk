...
<head>
    ...
    <title>AI HelpDesk - Agent Dashboard</title>
    ...
    <style>
        * {
        ...
        .welcome-stats .stat-item .dot.blue {
            background: #3B82F6;
        }
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-right">
            <!-- Status Toggle -->
            <button class="status-badge online" id="statusToggle" onclick="toggleStatus()">
            ...
            <div class="user-profile">
                ...
                <div>
                    ...
                    <div class="user-role agent">Support Agent</div>
                </div>
            </div>
    ...
    <div class="main-container">
        ...
        <div class="welcome-section">
            ...
            <div class="welcome-stats">
                <span class="stat-item">
                    ...
                    {{ auth()->user()->assignedTickets()->where('status', 'open')->count() }} New Tickets
                </span>
                <span class="stat-item">
                    <span class="dot yellow"></span>
                    {{ auth()->user()->assignedTickets()->where('status', 'in_progress')->count() }} In Progress
                </span>
                <span class="stat-item">
                    <span class="dot red"></span>
                    {{ auth()->user()->assignedTickets()->where('priority', 'critical')->count() }} Critical
                </span>
                <span class="stat-item">
                    <span class="dot blue"></span>
                    {{ auth()->user()->assignedTickets()->where('status', 'resolved')->count() }} Resolved Today
                </span>
                <span class="stat-item">
                    📅 {{ now()->format('F j, Y') }}
                </span>
        ...
        <div class="stats-grid">
            <div class="stat-card blue">
                ...
                <div class="stat-number">{{ auth()->user()->assignedTickets()->count() }}</div>
                <span class="stat-change neutral">Active assignments</span>
            </div>
            ...
            <div class="stat-card yellow">
                ...
                <div class="stat-number">{{ auth()->user()->assignedTickets()->where('status', 'in_progress')->count() }}</div>
                <span class="stat-change down">⏳ Working on these</span>
            </div>
            ...
            <div class="stat-card green">
                ...
                <div class="stat-number">{{ auth()->user()->assignedTickets()->where('status', 'resolved')->count() }}</div>
            ...
            <div class="stat-card purple">
                ...
                <span class="stat-change up">↓ 20% faster</span>
            </div>
        </div>
        ...
        <div class="two-col">
            ...
            <div class="col-card">
                ...
                @php
                    $myTickets = auth()->user()->assignedTickets()
                        ->with(['user', 'category'])
                        ->latest()
                        ->take(5)
                        ->get();
                        ...
                        <div class="ticket-item">
                            <div class="ticket-info">
                                ...
                                <div class="ticket-meta">
                                    From {{ $ticket->user->name }} • {{ $ticket->created_at->diffForHumans() }}
                                </div>
                            </div>
                            <div>
                ...
                @else
                    <div class="text-center py-8">
                        <p class="text-gray-500">No assigned tickets yet</p>
                        <p class="text-sm text-gray-400 mt-1">Tickets will appear here once assigned</p>
                    </div>
                @endif
            </div>
            ...
            <div class="col-card">
                ...
                <div class="action-list">
                    ...
                    <a href="{{ route('tickets.index') }}" class="action-btn">
                        ...
                        <div class="action-text">
                            <div class="action-name">My Tickets</div>
                            <div class="action-desc">View all assigned tickets</div>
                        </div>
                        <span class="action-arrow">→</span>
                    </a>

                    <a href="{{ route('knowledge.index') }}" class="action-btn">
                        ...
                        <div class="action-text">
                            ...
                            <div class="action-desc">Search for solutions</div>
                        </div>
                        <span class="action-arrow">→</span>
                    </a>

                    <a href="#" class="action-btn" onclick="toggleStatus()">
                        ...
                        <div class="action-text">
                            ...
                            <div class="action-desc">Change online/offline status</div>
                        </div>
                        <span class="action-arrow">→</span>
                    </a>
                </div>
    ...
    <script>
        function toggleStatus() {
            const badge = document.getElementById('statusToggle');
