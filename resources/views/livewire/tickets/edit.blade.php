{{-- resources/views/livewire/ticket/edit.blade.php --}}
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Ticket #{{ $ticket->ticket_id }}</h2>
        ...
        <form wire:submit.prevent="update">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('tickets.show', $ticket) }}" class="px-4 py-2 border rounded-md text-gray-700 hover:bg-gray-50">
                    Cancel
                </a>
