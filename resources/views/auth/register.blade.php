...
<head>
    ...
    <title>AI HelpDesk — Create Account</title>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .step-circle.active { background: rgba(91,95,237,0.2); border: 1.5px solid var(--accent); color: #A5A8F5; }
        .step-circle.pending { background: rgba(255,255,255,0.04); border: 1.5px solid var(--border); color: var(--text-muted); }

        .step-label { font-size: 11px; font-weight: 600; }
        .step-label.active  { color: #A5A8F5; }
        ...
        .terms-text a { color: #A5A8F5; text-decoration: none; font-weight: 600; }
        .terms-text a:hover { color: var(--text-primary); }
        ...
        .login-text a {
            color: #A5A8F5; text-decoration: none;
            font-weight: 600; transition: var(--transition);
        }

        .login-text a:hover { color: var(--text-primary); }
    ...
    <div class="layout">
        ...
        <aside class="sidebar" aria-label="Navigation">
            ...
            <nav class="nav">
                ...
                <a href="{{ route('register') }}" class="nav-item active" aria-current="page">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="main">
            <div class="form-wrap">
                ...
                <h1 class="heading">Join <em>AI HelpDesk</em></h1>
                <p class="subheading">Set up your workspace in under a minute</p>

                <!-- Progress steps -->
                <div class="steps" aria-label="Registration steps">
                    <div class="step">
                    ...
                    <div class="step">
                        ...
                        <span class="step-label pending">Verify</span>
                    </div>
                    <div class="step-line"></div>
                    <div class="step">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <button type="button" class="pw-toggle" onclick="togglePassword('password', 'eye1')" aria-label="Show or hide password">
                        ...
                        <div class="strength-hint" id="strength-hint">Use 8+ characters with numbers &amp; symbols</div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <button type="button" class="pw-toggle" onclick="togglePassword('password_confirmation', 'eye2')" aria-label="Show or hide confirm password">
